...
private:
    ...
    void uploadLocalFile(RemoteSession &session, const QString &localPath, const QString &targetDirectory = {});
    ...
    void uploadLocalPath(RemoteSession &session, const QString &localPath, const QString &targetDirectory = {});
    ...
    void downloadRemoteFile(RemoteSession &session, const QString &remotePath, const QString &targetDirectory = {});
    void downloadRemoteFile(const QString &remotePath);
    void downloadRemotePath(RemoteSession &session, const QString &remotePath, const QString &targetDirectory = {});
