...
/**
 * @brief 询问用户如何处理上传目标冲突。
 * @param localInfo 本地待上传项目。
 * @param remotePath 冲突的远程目标路径。
 * @param remoteItem 已存在的远程条目。
 * @return 用户选择的冲突处理动作。
 */
...
/**
 * @brief 为冲突上传生成用户指定的新远程路径。
 * @param remotePath 原远程目标路径。
 * @param localInfo 本地待上传项目。
 * @return 新远程路径；取消或非法输入时返回空字符串。
 */
